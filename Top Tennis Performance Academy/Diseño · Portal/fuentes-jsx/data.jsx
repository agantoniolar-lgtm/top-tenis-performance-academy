// data.jsx — fixtures for the Expediente prototype

const ROSTER = [
  { id: 'TTPA-014', nombre: 'Daniela Hernández',  edad: 16, cat: 'U16', utr: 9.2,  amtp: 14, itf: 'J60', coach: 'Marco Reyes',     turno: 'Matutino',  ingreso: 'Ago 2024', img: 'court' },
  { id: 'TTPA-003', nombre: 'Rodrigo Ávila',      edad: 18, cat: 'U18', utr: 10.3, amtp: 8,  itf: 'J100', coach: 'Alejandro',        turno: 'Matutino',  ingreso: 'Mar 2022', img: 'court' },
  { id: 'TTPA-007', nombre: 'Diego Vargas',       edad: 17, cat: 'U18', utr: 9.1,  amtp: 12, itf: 'J60',  coach: 'Alejandro',        turno: 'Matutino',  ingreso: 'Sep 2022', img: 'court' },
  { id: 'TTPA-001', nombre: 'Carlos Mendoza',     edad: 16, cat: 'U18', utr: 8.4,  amtp: 47, itf: '—',    coach: 'Marco Reyes',     turno: 'Matutino',  ingreso: 'Jun 2023', img: 'court' },
  { id: 'TTPA-002', nombre: 'Sofía Ruiz',         edad: 15, cat: 'U16', utr: 7.2,  amtp: 23, itf: '—',    coach: 'Marco Reyes',     turno: 'Vespertino', ingreso: 'Ene 2024', img: 'court' },
  { id: 'TTPA-009', nombre: 'Valentina Torres',   edad: 14, cat: 'U14', utr: 6.8,  amtp: 31, itf: '—',    coach: 'Marco Reyes',     turno: 'Matutino',  ingreso: 'Jul 2024', img: 'court' },
  { id: 'TTPA-022', nombre: 'Camila Soto',        edad: 13, cat: 'U14', utr: 5.9,  amtp: 44, itf: '—',    coach: 'Laura Méndez',     turno: 'Vespertino', ingreso: 'Nov 2024', img: 'court' },
  { id: 'TTPA-018', nombre: 'Andrés Beltrán',     edad: 16, cat: 'U18', utr: 7.9,  amtp: 28, itf: '—',    coach: 'Roberto García',   turno: 'Vespertino', ingreso: 'Feb 2024', img: 'court' },
];

// Deep file for the featured athlete
const FILE = {
  id: 'TTPA-014',
  ...
  tournaments: [
    { id: 1, name: 'AMTP Puebla Open U16',    date: '08–12 Abr 2026', cat: 'AMTP U16',  round: 'Final',     result: 'L 6-3 4-6 4-6',   utr: 9.2, ptf: 'done' },
    { id: 2, name: 'ITF J60 Cancún',          date: '02–06 Mar 2026', cat: 'ITF J60',   round: 'Q2',        result: 'L 4-6 3-6',       utr: 9.1, ptf: 'done' },
    { id: 3, name: 'UTR Match Series CDMX',   date: '15–17 Feb 2026', cat: 'UTR Open',  round: 'Cuartos',   result: 'L 5-7 6-4 6-10',  utr: 9.0, ptf: 'done' },
    { id: 4, name: 'AMTP Navidad Classic',    date: '15–19 Dic 2025', cat: 'AMTP U16',  round: 'Semifinal', result: 'L 6-7 6-4 4-6',   utr: 8.8, ptf: 'done' },
    { id: 5, name: 'ITF J30 Monterrey',       date: '12–16 Nov 2025', cat: 'ITF J30',   round: 'R1',        result: 'W 6-2 6-3 / L R2',utr: 8.5, ptf: 'done' },
    { id: 6, name: 'AMTP Aguascalientes U16', date: '10–13 Oct 2025', cat: 'AMTP U16',  round: 'Final',     result: 'W 6-4 6-2',       utr: 8.6, ptf: 'done' },
  ],
  activity: [
...
Object.assign(window, { ROSTER, FILE });
